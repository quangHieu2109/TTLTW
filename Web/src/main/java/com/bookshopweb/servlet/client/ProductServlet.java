...
public class ProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(type == null){
            Optional<Product> productFromServer = Protector.of(() -> productDAO.getById(id)).get(Optional::empty);
            ...
            if (id > 0L && productFromServer.isPresent()) {
                ...
                int totalProductReviews = Protector.of(() -> productReviewDAO.countByProductId(id)).get(0);
...
//
                ...
                List<ProductReview> productReviews = Protector.of(() -> productReviewDAO.getOrderedPartByProductId(
                ...
                int sumRatingScores = Protector.of(() -> productReviewDAO.sumRatingScoresByProductId(id)).get(0);
...
//
                ...
                int isWishlistItem = Optional.ofNullable((User) request.getSession().getAttribute("currentUser"))
                        .map(User::getId)
                        .map(userId -> Protector.of(() -> wishlistItemDAO
            ...
            int productQuantity = productDAO.selectQuantity(id);
