  ...
  <div class="container">
    ...
    <main class="row mb-5">
      <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/productManager/create"
        ...
        <div class="mb-3">
          <label for="product-yearPublishing" class="form-label"><fmt:message key="nam_san_xuat"/> <span class="text-danger">*</span></label>
          <input type="number"
        ...
        <div class="mb-3">
          <label for="product-imageName" class="form-label"><fmt:message key="hinh_san_pham"/></label>
          <input type="file"
                 class="form-control"
