...
<section class="section-content padding-y">
                                ...
                                <div class="filter-content collapse show" id="collapse_2">
                                    <div class="card-body pt-0">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="total_sold-DESC" name="order" id="radio_order_1" ${requestScope.order == 'total_sold-DESC' ? 'checked' : ''}>
                                            <label class="form-check-label" for="radio_order_1">
                                                <fmt:message key="ban_chay_nhat"/>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="total_sold-ASC" name="order" id="radio_order_2" ${requestScope.order == 'total_sold-ASC' ? 'checked' : ''}>
                                            <label class="form-check-label" for="radio_order_2">
                                                <fmt:message key="ban_it_nhat"/>
                                            </label>
                                        </div>
                                    </div> <!-- card-body.// -->
                                </div>
    ...
    <table class="table table-bordered table-striped table-hover align-middle">
        ...
        <tr>
            <th scope="col">#</th>
            <th scope="col">ID</th>
            <th scope="col"><fmt:message key="ten_sach"/></th>
            <th scope="col" style="width: 110px;"><fmt:message key="so_luong_da_nhap"/></th>
            <th scope="col" style="width: 110px;"><fmt:message key="so_luong_ban_duoc"/></th>
            <th scope="col" style="width: 110px;"><fmt:message key="so_luong_con_lai"/></th>
            <th scope="col" style="width: 110px;"><fmt:message key="ti_le_ban_hang"/></th>
        </tr>
        </thead>
        <tbody>
        <c:forEach var="product" varStatus="loop" items="${requestScope.productsAll}">
            <tr>
                ...
                <td>
                    <fmt:formatNumber value="${product.saleRate * 100}" type="number" minFractionDigits="1" maxFractionDigits="1"/>%
                </td>
    ...
    <nav class="mt-3 mb-5">
        <ul class="pagination justify-content-center">
            <li class="page-item ${requestScope.page == 1 ? 'disabled' : ''}">
                <a class="page-link"
                   href="${pageContext.request.contextPath}/admin/statiscalManager/product?page=${requestScope.page - 1}&startYear=${requestScope.startYear}&endYear=${requestScope.endYear}&order=${requestScope.order}">
            ...
            <c:forEach begin="1" end="${requestScope.totalPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item">
                            <a class="page-link"
                               href="${pageContext.request.contextPath}/admin/statiscalManager/product?page=${i}&startYear=${requestScope.startYear}&endYear=${requestScope.endYear}&order=${requestScope.order}">
                                    ${i}
                            </a>
                        </li>
                    </c:otherwise>
